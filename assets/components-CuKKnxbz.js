import{j as o}from"./vendor-react-DJbYE_OA.js";import{z as d}from"./index-BJaNhj3G.js";function f(t){const[n,e]=t.split("-").map(Number);return!n||!e?t:new Date(n,e-1,1).toLocaleDateString("en-GB",{month:"long",year:"numeric"})}function h(t){return t.toFixed(2)}function y(t){return new Map(t.map(n=>[n.id,n]))}function g(t,n,e){const[s,a]=e.split("-").map(Number),r=new Date(s,a-1,1),i=new Date(s,a,0),p=new Date(`${t}T00:00:00`),c=new Date(`${n}T00:00:00`),m=p>r?p:r,l=c<i?c:i;return l<m?0:Math.round((l.getTime()-m.getTime())/864e5)+1}function b({areaClass:t}){return o.jsx("style",{"code-path":"src/pages/payroll/components.tsx:14:5",children:`
@media print {
